<?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aCliente')){ ?>
  <a href="<?php echo base_url();?>index.php/clientes/adicionar" class="btn btn-success"><i class="icon-plus icon-white"></i> Adicionar Beneficiário</a>
<?php } ?>
<?php
...
<div class="widget-box">
 <div class="widget-title">
    ...
    <form method="get" action="<?php echo base_url(); ?>index.php/clientes/gerenciar">      
        ...
        <div class="span3">
            <input type="text" name="pesquisa"  id="pesquisa" autofocus placeholder="Nome do Beneficiário a pesquisar" class="span12" value="" >
        </div>
...
<table class="table table-bordered ">
    ...
    <tbody>
        <?php foreach ($results as $r) {
            ...
            if($this->permission->checkPermission($this->session->userdata('permissao'),'dCliente') && 1 == 2){
