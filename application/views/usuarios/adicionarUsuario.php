        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        <label for="conta_Usuario" class="control-label">Conta<span class="required">*</span></label>
                        <div class="controls">
                            <select id="conta_Usuario" name="conta_Usuario">   
                                        <option value = "">Selecione a conta do usuário</option>                                           
                                         <?php
                                          ...
                                          ?>
                                        <option value = "99">99 | Todas contas</option>
                                        </select>
                            <input id="telefone" type="hidden" name="telefone" value="99"  />
                        </div>
                    </div>
      ...
      $(document).ready(function(){
           ...
           $('#formUsuario').validate({
            ...
            messages: {
                  ...
                  conta:{ required: 'Campo Requerido.'},
