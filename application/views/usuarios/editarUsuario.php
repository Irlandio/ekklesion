            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                           <?php
                            if($result->nome_caixa == "99") {$contaA = "Todas contas";}else $contaA = $result->nome_caixa;
                            ?>
                            <select id="telefone" name="telefone">   
                                <option value = "<?php echo $result->conta_Usuario; ?>"><?php echo $result->conta_Usuario;" | ".$contaA; ?>
                                         <?php
